...
func IntExample() hamlet.Template {
	return hamlet.TemplateFunc(func(ctx context.Context, __w io.Writer) (__err error) {
		...
		var __var1 string
		if __var1, __err = hamlet.CaptureErrors(hamlet.EscapeString(hamlet.FormatString("%d", intVar))); __err != nil {
			return
		}
		...
		var __var2 string
		if __var2, __err = hamlet.CaptureErrors(hamlet.EscapeString(hamlet.FormatString("%b", intVar))); __err != nil {
			return
		}
		...
		var __var3 string
		if __var3, __err = hamlet.CaptureErrors(hamlet.EscapeString(hamlet.FormatString("%o", intVar))); __err != nil {
			return
		}
		...
		var __var4 string
		if __var4, __err = hamlet.CaptureErrors(hamlet.EscapeString(hamlet.FormatString("%x", intVar))); __err != nil {
			return
		}
		...
		var __var5 string
		if __var5, __err = hamlet.CaptureErrors(hamlet.EscapeString(hamlet.FormatString("%X", intVar))); __err != nil {
			return
		}
		...
		var __var6 string
		if __var6, __err = hamlet.CaptureErrors(hamlet.EscapeString(hamlet.FormatString("%c", intVar))); __err != nil {
			return
		}
...
func FloatExample() hamlet.Template {
	return hamlet.TemplateFunc(func(ctx context.Context, __w io.Writer) (__err error) {
		__buf, __isBuf := __w.(*bytes.Buffer)
		if !__isBuf {
			__buf = hamlet.GetBuffer()
...
func BoolExample() hamlet.Template {
	return hamlet.TemplateFunc(func(ctx context.Context, __w io.Writer) (__err error) {
		__buf, __isBuf := __w.(*bytes.Buffer)
		if !__isBuf {
			__buf = hamlet.GetBuffer()
...
func StringExample() hamlet.Template {
	return hamlet.TemplateFunc(func(ctx context.Context, __w io.Writer) (__err error) {
		__buf, __isBuf := __w.(*bytes.Buffer)
		if !__isBuf {
			__buf = hamlet.GetBuffer()
