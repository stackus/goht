...
import (
	...
	"github.com/stackus/hamlet/internal/logging"
	"github.com/stackus/hamlet/internal/protocol"
	"github.com/stackus/hamlet/internal/proxy"
)
...
var lspCmd = &cobra.Command{
	Use:   "lsp",
	Short: "Starts a language server for hamlet files",
	Long: `Starts a language server for hamlet files. The language server provides
...
func runLsp() error {
	...
	logger.Info().Msg("starting hamlet-lsp")
